...
struct OVRPLATFORM_API FOvrAchievementUpdate
{
    ...
    /** The unique field FOvrAchievementDefinition::ApiName used to reference the updated achievement. */
    UPROPERTY(BlueprintReadOnly, Category = "OvrPlatform|Models|AchievementUpdate|Field")
    FString Name;
...
/**
 * An GroupPresenceJoinIntent represents a user's intent to join a destination/lobby/match.
 * This class contains fields about the user's desired destination, lobby, match, and deeplink message.
 */
...
/**
 * An GroupPresenceLeaveIntent represents a user's intent to leave a destination/lobby/match.
 * This class contains fields about the user's desired destination, lobby, and match.
 */
...
/**
 * An ApplicationInvite contains information about the invite, including the ID,
 * destination, activity status, lobby, match, and recipient's user info.
 */
...
/**
 * Challenges leverage Destinations and Group Presence to create shareable links that allow
