...
public:
     ...
     * @param Names - The api_names(field FOvrAchievementDefinition::ApiName) of the achievements used to retrieve the definition information.
     ...
     * @param Names - The api_names(field FOvrAchievementDefinition::ApiName) of the achievements used to retrieve the progress information.
     * @param Count - The number of specified achievements names.
     */
    UFUNCTION(BlueprintCallable, meta = (Latent, LatentInfo = "LatentInfo", WorldContext = "WorldContextObject", ExpandEnumAsExecs = "OutExecs"), Category = "OvrPlatform|Achievements")
     ...
     * @param DeeplinkMessage - The new deeplink message to set for the user, overriding the current deeplink message.
     */
    UFUNCTION(BlueprintCallable, meta = (Latent, LatentInfo = "LatentInfo", WorldContext = "WorldContextObject", ExpandEnumAsExecs = "OutExecs"), Category = "OvrPlatform|GroupPresence")
     ...
     * @param ApiName - The unique name of the in-app destination to set, replacing the user's current destination.
     */
    UFUNCTION(BlueprintCallable, meta = (Latent, LatentInfo = "LatentInfo", WorldContext = "WorldContextObject", ExpandEnumAsExecs = "OutExecs"), Category = "OvrPlatform|GroupPresence")
     ...
     * @param IsJoinable - If true, the user can invite others to join them. If false, other users cannot join this user, for example, if the current session is full or only the host can invite others and the current user is not the host.
     */
    UFUNCTION(BlueprintCallable, meta = (Latent, LatentInfo = "LatentInfo", WorldContext = "WorldContextObject", ExpandEnumAsExecs = "OutExecs"), Category = "OvrPlatform|GroupPresence")
